...
public class c7_ErrorHandling extends ErrorHandlingBase {
    ...
    public void potato_potato() {
        Mono<String> currentUser = getCurrentUser()
                ...
                .onErrorMap(e -> new SecurityException("Security error", e));
    ...
    public void error_reporter() {
        ...
        Flux<String> messages = messageNode()
                .doOnError(e -> {
                    errorReportService(e);  // Ensure error is reported
                    errorReported.set(true); // Manually set flag to true when error occurs
                });
    ...
    public static class SecurityException extends Exception {
        ...
        public SecurityException(String securityError, Throwable cause) {
            super(cause);
        }
    }
}
